...
ALL_CMDS = {"audit", "build", "check-source", "clean", "cleanup-images", "cleanup-runs", "config", "configure", "discover", "doctor", "drift", "engine", "plan", "promote", "report", "rollback", "state", "verify-release",
