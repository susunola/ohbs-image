...
ALL_CMDS = {"ancestry", "audit", "build", "catalog", "channel", "check-source", "clean", "cleanup", "cleanup-images", "cleanup-runs", "config", "configure", "consumer", "cve", "discover", "distribution", "doctor", "dr", "drift", "engine", "event", "launch", "plan", "policy", "promote", "registry", "report", "rollback", "run", "serve", "state", "verify-release",
