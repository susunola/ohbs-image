...
ALL_CMDS = {"ancestry", "audit", "build", "catalog", "channel", "check-source", "clean", "cleanup", "cleanup-images", "cleanup-runs", "config", "configure", "discover", "distribution", "doctor", "drift", "engine", "launch", "plan", "policy", "promote", "registry", "report", "rollback", "run", "state", "verify-release",
