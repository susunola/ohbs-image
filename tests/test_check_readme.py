...
ALL_CMDS = {"audit", "build", "catalog", "check-source", "clean", "cleanup", "cleanup-images", "cleanup-runs", "config", "configure", "discover", "doctor", "drift", "engine", "launch", "plan", "promote", "registry", "report", "rollback", "run", "state", "verify-release",
