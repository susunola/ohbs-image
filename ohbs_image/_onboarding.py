...
def _render_config_toml(*, profile: str, region: str, zone: str,
                        instance: str, source: str, vpc: str, subnet: str,
                        sg: str, public_ip: bool, level: int,
                        generated_by: str = "configure") -> str:
    """Render a minimal valid ohbs-image.toml (shared by configure/quickstart)."""
    return f'''# Generated by ohbs-image {generated_by}
schema_version = 1
...
associate_public_ip = {str(bool(public_ip)).lower()}
...
def cmd_configure(args: argparse.Namespace) -> int:
    ...
    content = _render_config_toml(
        ...
        public_ip=bool(args.public_ip), level=int(args.level))
